      ...
      <Router>
        <>
          <Switch>
            ...
            <PrivateRoute path='/admin/stats' exact component={Stats} />
            <BlogAuthRoute path='/admin/blog' exact component={Blog} />
            <PrivateRoute path='/admin/blog-check-auth' exact component={CheckAuth} />
            <Route
              exact
              path='/admin/login'
              render={(props) => (
