...
const Main = ({ goToFunc }) => {
    return (
        <div className="h-[100vh] flex items-center justify-start relative overflow-hidden px-4 w-full">
            <div className="absolute top-10 right-1/3 w-64 h-64 rounded-full bg-blue-400 opacity-5 blur-3xl"></div>
            ...
            <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce" onClick={goToFunc[1]}>
