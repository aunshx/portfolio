  ...
  return (
    ...
    >
      <div
        ...
        className="max-w-md min-h-[220px] hover:text-brand hover:border-brand flex flex-col items-start justify-around px-8 py-4 bg-zinc-900 bg-opacity-75 backdrop-blur-sm opacity-80 rounded-xl border border-zinc-700 shadow-xl w-full text-white"
      >
