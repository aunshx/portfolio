...
const Card = ({
  ...
  return (
      <a href = { link } target = '_blank' rel = 'noreferrer nofollow' className="max-w-md max-h-xl border-2 opacity-70 border-zinc-800 bg-zinc-900 rounded-lg hover:scale-105 transition hover:text-brand dark:hover:border-brand dark:hover:text-brand text-white">
          ...
          <div className="flex flex-col items-start justify-around p-4 gap-y-2">
              <div className='flex flex-col gap-y-2'>
                  ...
                  <p className="font-normal text-sm text-gray-500 mb-3">{description}</p>
              </div>
